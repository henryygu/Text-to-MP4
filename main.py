...
input_path = r"D:\Github\Text-to-MP4\InputTxtFiles"

# Set the directory path where the output files should be saved
output_dir = r"D:\Github\Text-to-MP4\OutputMP3"

# Set the directory path where the output txt files should be saved
output_dir_txt = r"D:\Github\Text-to-MP4\ProcessedTXT"
...
for file_path in glob.glob(os.path.join(input_path, "*.txt")):
    ...
    command = [
        "python",
        "D:/Github/tortoise-tts/tortoise/read_fast.py",
        "--voice", "stephenfry",
        "--text", file_path,
        "--seed", "1684581035",
    ...
    # Move the text file somewhere else
    shutil.move(file_path, output_dir_txt)
